@include('layouts.mainsite.header')
        ...
        <div class="container">
          <div class="grid grid-cols-12">
            <div class="col-span-12">
              <div
                class="max-w-[480px] mx-auto text-center text-white relative z-[1]"
              >
                <div class="mb-5">
                  <span class="text-base block">About us</span>
                </div>
                <h1
      ...
      <section class="pt-[80px] lg:pt-[120px]">
        <div class="container">
          <div
            class="grid grid-cols-12 gap-x-[15px] sm:gap-x-[20px] mb-[-40px]"
          >
            <div
              class="col-span-12 lg:col-span-6 mb-[40px] scene"
            ...
            <div class="col-span-12 lg:col-span-6 xl:pl-[100px] mb-[40px]">
              ...
              >
              <h2
                class="font-lora text-primary text-[24px] sm:text-[30px] leading-[1.388] xl:text-[35px] capitalize mb-[15px] lg:mb-[50px] font-medium"
              >
              ...
              <ul class="flex flex-wrap list-none">
                <li class="block">
                  <span class="font-lora text-secondary text-xl"
                    ><span class="counter-up">20</span> <span>k+</span></span
                  >
                  <p>Properties</p>
                </li>
                <li class="block pl-[30px] sm:pl-[40px] md:pl-[60px]">
                  <span class="font-lora text-secondary text-xl"
                    ><span class="counter-up">12</span> <span>k+</span></span
                  >
                  <p>Customers</p>
                </li>
                <li class="block pl-[30px] sm:pl-[40px] md:pl-[60px]">
                  <span class="font-lora text-secondary text-xl"
                    ><span class="counter-up">160</span> <span>+</span></span
                  >
                  <p>Awards Win</p>
                </li>
              </ul>
      ...
      <section class="pt-[80px] pb-[120px] lg:py-[120px]">
        <div class="container">
          <div class="grid grid-cols-12">
            <div class="col-span-12">
              <div class="mb-[30px] lg:mb-[60px] text-center">
                ...
                >
                  Services that we Provide<span class="text-secondary">.</span>
                </h2>
              </div>
            </div>
          </div>
          ...
          <div
            class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[30px]"
          >
            <div class="relative group">
              <a href="properties-details.html" class="block">
                <img
                  src="{{asset('')}}assets/images/service/service1.png"
            ...
            <div class="relative group">
              <a href="properties-details.html" class="block">
                <img
                  src="{{asset('')}}assets/images/service/service2.png"
                  class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]"
                  loading="lazy"
                  width="270"
                  height="290"
            ...
            <div class="relative group">
              <a href="properties-details.html" class="block">
                <img
                  src="{{asset('')}}assets/images/service/service3.png"
                  class="w-full h-full block mx-auto rounded-[6px_6px_0px_0px]"
                  loading="lazy"
                  width="270"
                  height="290"
        ...
        <div class="container">
          <div class="grid grid-cols-12 gap-6 items-center">
            <div class="col-span-12 lg:col-span-6">
              ...
              >
                We Provide Latest Properties for our valuable Clients.<span
              ...
              <div class="scene" data-relative-input="true">
                <img
                  data-depth="0.1"
                  src="{{asset('')}}assets/images/about/about7.png"
                  class=""
                  loading="lazy"
                  width="729"
                  height="663"
            ...
            <div class="col-span-12 lg:col-span-6 lg:pl-[70px]">
              ...
              <div class="-mb-10 mt-12 xl:mt-[70px] 2xl:mt-[100px]">
                <div class="flex flex-wrap mb-5 lg:mb-10">
                  <img
                    src="{{asset('')}}assets/images/icon/doller.png"
                    class="self-start mr-5"
                    loading="lazy"
                    width="50"
                    height="50"
                    alt="about Image"
                  ...
                  <div class="flex-1">
                    <h3
                      class="font-lora text-primary text-[22px] xl:text-lg capitalize mb-2"
                    >
                      Budget Friendly
                    </h3>
                    <p class="max-w-[315px]">
      ...
      <section
        class="testimonial-section pb-[80px] lg:pb-[120px] bg-center bg-no-repeat bg-white z-10"
      >
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    ...
                    <div class="pl-[50px] xl:pl-[150px]">
                      <div
                        class="inline-block relative bg-primary text-primary rounded-[30px] z-10"
                      >
                        <img
                          src="assets/images/testimonial/person2.png"
                          class="w-auto h-auto block mx-auto relative z-[2] thumb"
                          loading="lazy"
                          width="402"
                          height="505"
                          alt="Oliver Stephen"
                        />
                        <img
                          class="absolute left-[0px] top-0 z-[1]"
                    ...
                    >
                      ...
                      >
                        <div class="relative">
                          ...
                          <span
                            class="text-secondary text-tiny capitalize inline-block mb-[5px] xl:mb-[10px]"
                            >Testimonial</span
                          >
                          <h2
                            class="font-lora text-primary text-[24px] xl:text-xl capitalize mb-[10px] xl:mb-[20px] leading-[1.2] font-medium"
                          >
                            Reviews from our <br class="hidden xl:block" />
                            happy Clients<span class="text-secondary">.</span>
                          </h2>
                          <p class="max-w-[480px]">
                            Bary do a great job to find the perfect home. It’s
                            very easy for every one to buy, sell or rent
                            property we belive they continure their great
                            service and appriciate them recomended.
                          </p>
                        </div>

                        <ul>
                          <li
                            class="flex flex-wrap items-center justify-between mt-4"
                          >
                            <span
                              class="font-lora text-[18px] leading-none capitalize text-secondary"
                              >Oliver Stephen</span
                            >
            ...
            <div class="col-span-12">
              <div class="mb-[60px] text-center">
                ...
                <h2
                  class="font-lora text-primary text-[24px] sm:text-[30px] xl:text-xl capitalize font-medium"
                >
                  Reliable Partner’s<span class="text-secondary">.</span>
                </h2>
              </div>
                ...
                <div class="swiper">
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide text-center">
                      <a href="#" class="block">
                        <img
                          ...
                          class="w-auto h-auto block mx-auto"
                          loading="lazy"
                          width="125"
                          height="109"
                          alt="@@title"
                    ...
                    <div class="swiper-slide text-center">
                      <a href="#" class="block">
                        <img
                          src="assets/images/brand/brand5.png"
                          class="w-auto h-auto block mx-auto"
                          loading="lazy"
                          width="125"
                          height="109"
      ...
      <section class="team-section pb-[80px] lg:pb-[125px] overflow-hidden">
        <div class="container">
          <div
            class="grid sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-x-5 md:gap-x-[30px] mb-[-30px]"
          >
            <div
              class="xl:pr-[20px] self-center mb-[30px] sm:col-span-3 lg:col-span-1 max-w-[500px]"
            >
              <span
                class="text-secondary text-tiny capitalize inline-block mb-[15px]"
                >Our Agents</span
              >
              <h2
                class="font-lora text-primary text-[24px] sm:text-[30px] leading-[1.277] xl:text-xl capitalize mb-[15px] font-medium"
              >
                Here is our Experts<span class="text-secondary">.</span>
              </h2>
              ...
              <a
                href="blog-grid.html"
                class="flex flex-wrap items-center text-secondary text-tiny mt-[20px]"
                >View all Post
                <svg
                  class="ml-[10px]"
                  width="26"
            ...
            <div class="text-center group mb-[30px]">
              <div class="relative rounded-[6px_6px_0px_0px]">
                ...
                <ul
                  class="flex flex-col absolute w-full top-[30px] left-0 overflow-hidden"
                >
                  <li
              ...
              >
                ...
                <p
                  class="font-normal text-[14px] leading-none capitalize mt-[5px] group-hover:text-body"
                >
                  Real Estate Broker
                </p>
              </div>
            ...
            <div class="text-center group mb-[30px]">
              <div class="relative rounded-[6px_6px_0px_0px]">
                <a href="agent-details.html">
                  <img
                    src="assets/images/team/person2.png"
                    class="w-auto h-auto block mx-auto"
                    loading="lazy"
                    width="215"
                    height="310"
