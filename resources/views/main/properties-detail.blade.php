        ...
        <div class="container">
          <div class="grid grid-cols-12">
            <div class="col-span-12">
              <div
                class="max-w-[600px] mx-auto text-center text-white relative z-[1]"
              >
                <div class="mb-5">
                  <span class="text-base block">Our Properties</span>
                </div>
                <h1
        ...
        <div class="container">
          <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
            <div class="col-span-12 md:col-span-6 lg:col-span-8 mb-[30px]">
              <img
                src="{{asset('')}}assets/images/properties-details/post1.png"
                class="w-auto h-auto"
                loading="lazy"
              ...
              <div class="mt-[45px] mb-[35px]">
                ...
                <h3
                  class="font-light text-[18px] text-secondary underline mb-[20px]"
                >
                ...
                >
                  <div class="col-span-7">
                    ...
                    >
                      <img
                        ...
                        src="{{asset('')}}assets/images/properties-details/01.png"
                        alt="gallery image"
                        loading="lazy"
                        width="270"
                        height="187"
                  ...
                  <div class="col-span-5">
                    ...
                    >
                      <img
                        class="object-cover rounded-[8px] w-full h-full"
                        src="assets/images/properties-details/03.png"
                        alt="gallery image"
                        loading="lazy"
                        width="170"
                        height="187"
                  ...
                  <div class="col-span-5">
                    <a
                      href="assets/images/properties-details/gallery/07.png"
                      class="gallery-image"
                    >
                      <img
                        class="object-cover rounded-[8px] w-full h-full"
                        src="assets/images/properties-details/07.png"
                        alt="gallery image"
                        loading="lazy"
                        width="170"
                        height="187"
                  ...
                  <div class="col-span-7">
                    <a
                      href="assets/images/properties-details/gallery/05.png"
                      class="gallery-image"
                    >
                      <img
                        class="object-cover rounded-[8px] w-full h-full"
                        src="assets/images/properties-details/05.png"
                        alt="gallery image"
                        loading="lazy"
                        width="270"
                        height="187"
              ...
              <div class="grid grid-cols-12 mt-[70px]">
                <div
                  class="col-span-12 flex flex-wrap flex-col md:flex-row md:items-center justify-between mb-[50px] lg:mb-[70px]"
                >
                  <div class="mb-5 xl:mb-0">
                    <h2
                      class="font-lora text-primary text-[24px] sm:text-[28px] capitalize font-medium"
                    >
                      Nearby Places<span class="text-secondary">.</span>
                    </h2>
                  </div>
                  <ul class="all-properties flex flex-wrap lg:pt-[10px]">
                    <li
                      data-tab="ForBuy"
                      class="mr-[30px] md:mr-[35px] mb-4 lg:mb-0 leading-none active"
                    >
                      <button
                    ...
                    <li
                      data-tab="ForSale"
                      class="mr-[30px] md:mr-[35px] mb-4 lg:mb-0 leading-none"
                    >
                      <button
                        class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out"
                      >
                    ...
                    <li
                      data-tab="co-living"
                      class="md:mr-[0px] mb-4 lg:mb-0 leading-none"
                    >
                      <button
                        class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out"
                      >
                ...
                <div class="col-span-12 mb-[80px]">
                  <div id="ForBuy" class="properties-tab-content active">
                    <ul>
                      <li
                        class="flex flex-wrap items-center justify-between pb-[25px] mb-[25px] border-b border-[#016450]"
                      >
                        <div
                          class="flex flex-wrap mb-[20px] sm:mb-[0px] md:mb-[20px]"
                        >
                          <img
                            class="self-start mr-[40px]"
                            src="assets/images/icon/medist.png"
                            loading="lazy"
                            width="54"
                            height="68"
                            alt="logo"
                          ...
                          <div class="flex-1">
                            <h4
                              class="text-primary font-lora text-[18px] leading-none mb-[5px]"
                            >
                              Mediset Hospital Ltd.
                            </h4>
                            <span class="text-[14px] leading-none"
                              >(0.5 km distance)</span
                            >
                          </div>
                        </div>
                      ...
                      >
                        <div
                          class="flex flex-wrap mb-[20px] sm:mb-[0px] md:mb-[20px] lg:mb-[0px]"
                        >
                          <img
                            class="self-start mr-[40px]"
                      ...
                      <li class="flex flex-wrap items-center justify-between">
                        ...
                        >
                          <img
                            class="self-start mr-[40px]"
                            src="assets/images/icon/medihealth.png"
                            loading="lazy"
                            width="56"
                            height="66"
                            alt="logo"
                ...
                <div class="col-span-12">
                  ...
                  <ul class="mt-[50px] lg:mt-[70px]">
                    ...
                    >
                      <img
                        class="self-start mr-[35px] border border-primary rounded-[26px]"
                        src="assets/images/commentor/01.png"
                        width="78"
                        height="80"
                        loading="lazy"
                        alt="image"
                    ...
                    >
                      <img
                        class="self-start mr-[35px] border border-primary rounded-[26px]"
                        src="assets/images/commentor/02.png"
                        width="78"
                        height="80"
                        loading="lazy"
                        alt="image"
                    ...
                    >
                      <img
                        class="self-start mr-[35px] border border-primary rounded-[26px]"
                        src="assets/images/commentor/03.png"
                        width="78"
                        height="80"
                        loading="lazy"
                        alt="image"
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-4 mb-[30px]">
              <aside class="mb-[-60px] asidebar">
                <div class="mb-[60px]">
                  <h3
                    class="text-primary leading-none text-[24px] font-lora underline mb-[40px] font-medium"
                  >
                    Property Search <span class="text-secondary">.</span>
                  </h3>
                  ...
                  <form action="#" class="relative">
                    <div class="relative mb-[25px] bg-white">
                      ...
                      />
                      <svg
                        class="absolute top-1/2 -translate-y-1/2 z-[1] left-[20px] pointer-events-none"
                        width="14"
                        height="14"
                        viewBox="0 0 14 14"
                        fill="none"
                ...
                <div class="mb-[60px]">
                  <h3
                    class="text-primary leading-none text-[24px] font-lora underline mb-[40px] font-medium"
                  >
                    Featured Property<span class="text-secondary">.</span>
                  </h3>
                  <div class="sidebar-carousel relative">
                        ...
                        <div class="swiper-slide">
                          ...
                          >
                            <div class="relative">
                              <a href="properties-details.html" class="block">
                                <img
                                  src="assets/images/properties/propertie-slider-1.png"
                                  class="w-full h-full"
                                  loading="lazy"
                                  width="370"
                                  height="266"
                              ...
                              <div
                                class="flex flex-wrap flex-col absolute top-5 right-5"
                              >
                                <button
                                  class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white mb-[5px] text-xs"
                                >
                                  <img
                                    class="mr-1"
                                ...
                                <button
                                  class="flex flex-wrap items-center bg-primary p-[5px] rounded-[2px] text-white text-xs"
                                >
                                  <img
                                    class="mr-1"
                            ...
                            >
                              ...
                              <h4 class="leading-none">
                                <a
                                  ...
                                  >18B Central Street, San Francisco</a
                                >
                              </h4>
                              <ul class="mt-[10px]">
                                <li
                                ...
                                >
                                  ...
                                  <span class="flex flex-wrap items-center">
                                    ...
                                    <button
                                      class="text-[#B1AEAE] hover:text-secondary"
                                    >
                                      <svg
                                        width="16"
                                        height="16"
                          ...
                          >
                            <div class="relative">
                              <a href="properties-details.html" class="block">
                                <img
                                  src="assets/images/properties/propertie-slider-2.png"
                                  class="w-full h-full"
                                  loading="lazy"
                                  width="370"
                                  height="266"
                    ...
                    <div
                      class="flex flex-wrap items-center justify-center mt-[25px]"
                    >
                      <div
                ...
                <div class="mb-[60px]">
                  ...
                  <div
                    class="grid sm:grid-cols-2 lg:grid-cols-2 gap-x-[20px] mb-[-20px]"
                  >
                    <!-- single team start -->
                    <div class="text-center group mb-[30px]">
                      ...
                      >
                        ...
                        <p
                          class="font-light text-[12px] leading-none capitalize mt-[5px]"
                        >
                          Real Estate Agent
                        </p>
                      </div>
