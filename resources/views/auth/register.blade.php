    ...
    <div class="overflow-hidden">
        ...
        <header id="sticky-header" class="absolute left-0 top-[15px] lg:top-[30px] xl:top-[45px] w-full z-10">
                            ...
                            <nav class="flex flex-wrap items-center">
                                <ul class="hidden lg:flex flex-wrap items-center font-lora text-[16px] xl:text-[18px] leading-none text-black">
                                    ...
                                    <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                        ...
                                        <a href="{{route('about-us')}}" class="transition-all hover:text-secondary">About</a>
            ...
            " style="background-image: url('assets/images/mega-menu/image.png');">
                                            ...
                                            <li>
                                                <ul>
                                                    <li class="text-primary underline font-lora mb-[30px]">Property Details</li>
                                                    <li class="mb-[25px] last:mb-0">
                                                        <a href="{{route('add-properties')}}" class="font-lora text-[14px] hover:text-secondary">Add properties</a>
                                                    </li>

                                                    <li class="mb-[25px] last:mb-0">
                                                        <a href="{{route('properties-detail')}}" class="font-lora text-[14px] hover:text-secondary">Properties details</a>
                                                    </li>
            ...
            ">
                                            ...
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="service.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-primary hover:text-white text-center my-[-1px] rounded-t-[12px]">Service</a>
                                            </li>

                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="single-service.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-primary hover:text-white text-center my-[-1px]">single service</a>
                                            </li>

                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                                <a href="login.html" class="font-lora leading-[1.571] text-[14px] text-primary p-[10px] capitalize block transition-all hover:bg-primary hover:text-white text-center my-[-1px]">login</a>
                                            </li>
                                            <li class="border-b border-dashed border-primary border-opacity-40 last:border-b-0 hover:border-solid transition-all">
                                    ...
                                    <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                        ...
                                        <a href="{{route('blog-details')}}" class="transition-all hover:text-secondary">Blog</a>


                                    </li>
                                    <li class="mr-7 xl:mr-[40px] relative group py-[20px]">

                                        <a href="{{route('contact-us')}}" class="transition-all hover:text-secondary">Contact</a>
                                ...
                                <ul class="flex flex-wrap items-center">
                                    <li class="sm:mr-5 xl:mr-[20px] relative group"><a href="#">
                                            <img src="{{asset('')}}assets/images/user/avater.png" loading="lazy" width="62" height="62" alt="avater">
                                        </a>
                ...
                <nav class="offcanvas-menu mr-[20px]">
                    <ul>
                        ...
                        <li class="relative block border-b-primary border-b">
                            <a href="{{route('about-us')}}" class="block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">About</a>
                        ...
                        <li class="relative block border-b-primary border-b"><a href="#" class="relative block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">Pages</a>
                            ...
                            <ul class="offcanvas-submenu static top-auto hidden w-full visible opacity-100 capitalize">
                                ...
                                <li>
                                    <a href="{{route('contact-us')}}" class="text-sm pt-3 px-10 pb-1 text-black font-light block transition-all hover:text-secondary">contact
                                        us</a>
                                </li>
                                <li>
                        ...
                        <li class="relative block border-b-primary border-b"><a href="{{route('blog-details')}}" class="relative block capitalize text-black hover:text-secondary text-base my-2 py-1 px-5">Blog</a>


                        </li>
                        <li class="relative block border-b-primary border-b"><a href="{{route('contact-us')}}" class="relative block capitalize text-black hover:text-secondary text-base my-2 py-1 px-5">Contact</a></li>
                    </ul>
                </nav>
                <!-- offcanvas-menu end -->
                ...
                <div class="grid grid-cols-12">
                    <div class="col-span-12">
                        <div
                            ...
                            <div class="mb-5">
                                <span class="text-base block">Register</span>
                            </div>
                            <h1
            ...
            <div class="container">
                    <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
                        <div class="col-span-12 lg:col-span-6 mb-[30px]">
                            <h2
                                class="font-lora text-primary text-[24px] sm:text-[30px] leading-[1.277] xl:text-xl mb-[15px] font-medium">
                                Create Account<span class="text-secondary">.</span>
                            </h2>
                            ...
                            <form action="{{route('registers')}}" method="post">
                                ...
                                <div class="col-span-12">
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <div
                                            class="flex flex-wrap items-center justify-between w-full sm:w-[400px]">
                                            <div class="flex flex-wrap mt-[15px] items-center">
                                                <input
                                                    type="checkbox"
                                                    id="checkbox1"
                                                    name="Remember me" />
                                                <label for="checkbox1" class="ml-[5px] cursor-pointer">
                                                    I agree with the
                                                    <a href="#" class="underline text-secondary">Terms & Conditions</a></label><br />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-span-12 lg:col-span-6 mb-[30px]">
                            <img
                                src="assets/images/contact/image2.png"
                                class="w-full lg:max-w-[538px] h-auto rounded-[10px]"
                                width="546"
                                height="668"
                                alt="image" />
                        </div>
